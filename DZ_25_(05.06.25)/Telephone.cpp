...
void TELEPHONE::SetNickname(const string& nickname) {
...
void TELEPHONE::SetColor(const string& color) {
	this->color = color;
}
...
void TELEPHONE::SetCompany(const string& company) {
...
void TELEPHONE::SetModel(int model) {
...
void TELEPHONE::SetBattery(int battery) {
